...
print("-------------------------")
pathlib.Path("main_PyPoll.txt").write_text("Election Results\n-------------------------\nTotal Votes: 3521001\n-------------------------\nKhan: 63.00001050837531% (2218231 votes)\nCorrey: 19.999994319797125% (704200 votes)\nLi: 13.999996023857989% (492940 votes)\nO'Tooley: 2.999999147969569% (105630 votes)\n-------------------------\nWinner: Khan\n-------------------------")
